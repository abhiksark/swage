// test/Conversion/SwageToCPU/segmented-sum-region-runner.mlir
...
// A region executes under the runner once the math conversion is in the
// pipeline: sums are of exp2 of each element.
module {
