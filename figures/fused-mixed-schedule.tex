...
% M7 fused mixed-policy schedule: one launch, four warp slots per
...
\node[swsubtitle] at (0, 0.5)
  {One launch covers every task; \detokenize{task_ids} maps each block
   to its segments.};
...
\node[font=\scriptsize, text=swgreen] at (4.55, -1.12)
...
\node[font=\scriptsize, text=swpurple] at (8.06, -1.12)
